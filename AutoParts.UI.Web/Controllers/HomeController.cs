...
namespace AutoParts.UI.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult DetalhesProduto(int? id)
        {
            try
            {
                ...
                produtoVM.Imagem = OnUpload.ObterImagem(produtoVM.ProdutoId, "Produto");
        ...
        public ActionResult DetalhesServico(int? id)
        {
            try
            {
                ...
                servicoVM.Imagem = OnUpload.ObterImagem(servicoVM.ServicoId, "Servico");
